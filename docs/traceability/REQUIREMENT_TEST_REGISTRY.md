...
| M1 remaining domain/data state invariants | Kotlin unit/property tests | Enabled-alarm recurrence/outbox transaction and device-protected mirror remain | In Progress | M1 |
